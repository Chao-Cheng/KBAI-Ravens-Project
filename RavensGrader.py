...
def grade():
    ...
    with open(os.path.join("Problems", "TestProblemSetList.txt")) as fd0:
        for line0 in fd0:
            line0 = line0.rstrip()
            totals = {"Correct": 0, "Skipped": 0, "Incorrect": 0}
            with open(os.path.join("Problems", line0, "ProblemList.txt")) as fd1: #"TestProblem.txt")) as fd1: #"ProblemList.txt")) as fd1:
                for line1 in fd1:
                    line1 = line1.rstrip()
